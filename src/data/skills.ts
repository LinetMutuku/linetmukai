...
export const skills: Skill[] = [
  ...
  { name: 'Sass/SCSS', icon: '💅', level: 'Advanced', category: 'frontend' },
  ...
  { name: 'shadcn/ui', icon: '🧩', level: 'Advanced', category: 'frontend' },
  { name: 'Framer Motion', icon: '🎬', level: 'Advanced', category: 'frontend' },
  { name: 'GSAP', icon: '✨', level: 'Advanced', category: 'frontend' },
  { name: 'Storybook', icon: '📚', level: 'Advanced', category: 'frontend' },
  { name: 'Figma', icon: '🎨', level: 'Advanced', category: 'frontend' },
  { name: 'TanStack Query', icon: '🔄', level: 'Advanced', category: 'frontend' },
  { name: 'React Hook Form', icon: '📝', level: 'Advanced', category: 'frontend' },
  ...
  { name: 'Vitest', icon: '🧪', level: 'Advanced', category: 'tools' },
  { name: 'Playwright', icon: '🎭', level: 'Advanced', category: 'tools' },
